...
import com.example.firestoretest.databinding.ActivityFirestoreBinding
...
class FirestoreActivity : AppCompatActivity() {
    ...
    private fun addItem() {
        ...
        val inStock = binding.checkInstock.isChecked
    ...
    private fun queryItem(itemID: String) {
        itemsCollectionRef.document(itemID).get()
            .addOnSuccessListener {
                ...
                binding.checkInstock.isChecked = it.getBoolean("instock") == true
